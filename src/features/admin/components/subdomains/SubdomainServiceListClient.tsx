...
export default function SubdomainServiceListClient({ services }: { services: Service[] }) {
              ...
              >
                <div>
                  <div className="flex items-start justify-between gap-2.5">
                    ...
                    <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider border transition-all flex-shrink-0 bg-blue-50 text-blue-500 border-blue-200">
                      Subdomain Route
                    </span>
                  </div>
                ...
                <div className="flex items-center justify-between border-t border-gray-50 pt-4 mt-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <Link
                      href={`/admin/subdomains/services/${service.slug.replace(/^\//, '')}`}
                      ...
                      title="Edit Market Area Template"
                    >
                      <Edit2 size={14} />
                    </Link>
                  </div>
